...
const SAMPLE_QUIZZES_BY_TOPIC: Record<
  string,
  Array<{
    question: string;
    option_a: string;
...
> = {
  ...
  "The Alphabet A-M": [
    ...
    {
      question: "How many letters are from A to M?",
      option_a: "10",
      option_b: "11",
      option_c: "12",
      option_d: "13",
    ...
    {
      question: "Which letter makes the sound /b/ ?",
      option_a: "A",
      option_b: "B",
      option_c: "C",
      option_d: "D",
  ...
  "Vowels and Consonants": [
    ...
    {
      question: "Is the letter T a vowel?",
      option_a: "Yes",
      option_b: "No",
      option_c: "Sometimes",
      option_d: "Maybe",
  ...
  "My Body Parts": [
    {
      question: "What body part do we use to see things?",
      option_a: "Ears",
      option_b: "Eyes",
      option_c: "Nose",
      option_d: "Mouth",
    ...
    {
      question: "What do we smell nice flowers with?",
      option_a: "Eyes",
      option_b: "Hands",
      option_c: "Nose",
      option_d: "Feet",
  ...
  "Living and Non-living": [
    ...
    {
      question: "Do plants grow like other living things?",
      option_a: "Yes",
      option_b: "No",
      option_c: "Never",
      option_d: "Rarely",
  ...
  "Shapes Around Us": [
    ...
    {
      question: "A book is usually which shape?",
      option_a: "Circle",
      option_b: "Square",
      option_c: "Triangle",
      option_d: "Rectangle",
    ...
    {
      question: "A building block is usually what shape?",
      option_a: "Circle",
      option_b: "Square",
      option_c: "Triangle",
      option_d: "Oval",
  ...
  "My Family": [
    ...
    {
      question: "A family pet could be a?",
      option_a: "Car",
      option_b: "Dog",
      option_c: "Tree",
      option_d: "Book",
    ...
    {
      question: "A brother and sister are your?",
      option_a: "Parents",
      option_b: "Siblings",
      option_c: "Cousins",
      option_d: "Friends",
  ...
  "Plants Around Us": [
    ...
    {
      question: "Leaves are usually what color?",
      option_a: "Blue",
      option_b: "Red",
      option_c: "Green",
      option_d: "Yellow",
  ...
  "My School": [
    {
      question: "What do we do at school?",
      option_a: "Sleep",
      option_b: "Learn and play",
      option_c: "Cook",
      option_d: "Drive",
      correct_answer: "B",
    },
    {
      question: "Who helps us learn at school?",
      option_a: "Driver",
      option_b: "Teacher",
      option_c: "Doctor",
      option_d: "Farmer",
    ...
    {
      question: "Where do we play at school?",
      option_a: "Library",
      option_b: "Playground",
      option_c: "Canteen",
      option_d: "Office",
    ...
    {
      question: "Books are kept in the?",
      option_a: "Playground",
      option_b: "Canteen",
      option_c: "Library",
      option_d: "Office",
    ...
    {
      question: "We should be polite to our teachers?",
      option_a: "Rude",
      option_b: "Polite",
      option_c: "Noisy",
      option_d: "Lazy",
  ...
  "Good Habits": [
    ...
    },
    {
      ...
      option_a: "After eating only",
      option_b: "Before eating only",
      option_c: "Before and after eating",
      option_d: "Never",
      correct_answer: "C",
    },
    {
    ...
    {
      question: "Helping parents is a?",
      option_a: "Bad habit",
      option_b: "Good habit",
      option_c: "Boring task",
      option_d: "Waste of time",
      correct_answer: "B",
    },
    {
      question: "We should say please when we request something?",
      option_a: "Demand something",
      option_b: "Request something",
      option_c: "Take something",
      option_d: "Hide something",
      correct_answer: "B",
    },
  ],
  "Safe and Clean": [
    {
      question: "When should we wash our hands?",
      option_a: "Never",
      option_b: "Before eating",
      option_c: "Once a year",
      option_d: "Only Sunday",
      correct_answer: "B",
    },
    {
  ...
  "Parts of Computer": [
    {
      question: "What shows pictures on a computer?",
      option_a: "Mouse",
      option_b: "Monitor",
      option_c: "CPU",
      option_d: "Wire",
  ...
  "Using the Mouse": [
    {
      question: "How many main buttons does a computer mouse have?",
      option_a: "1",
      option_b: "2",
      option_c: "3",
      option_d: "4",
    ...
    {
      question: "What action should you take to open a file?",
      option_a: "Single click",
    ...
    {
      question: "To select an item on the screen, which click do we use?",
      option_a: "Left click",
      option_b: "Shake",
      option_c: "Throw",
      option_d: "Press all",
    ...
    async function loadQuizzes() {
      ...
      try {
        ...
        try {
          ...
          console.warn(
            "Client-side quiz fetch failed, attempting server function fallback:",
            clientErr,
          );
          try {
            const serverRes = await getQuizzesWithAnswersServer({ data: { lessonId } });
            ...
            throw new Error(
              serverErr.message || "Failed to load quizzes from both client and server",
            );
          }
        }
  ...
  function triggerConfetti() {
    ...
    for (let i = 0; i < 80; i++) {
      list.push({
        ...
        x: Math.random() * 100,
        y: Math.random() * 40 - 20,
        color: ["#818CF8", "#A78BFA", "#F472B6", "#F59E0B", "#10B981"][
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center p-4 text-center bg-gradient-to-tr from-slate-50 via-indigo-50/30 to-slate-100 dark:from-[#0F172A] dark:via-[#1E1B4B] dark:to-[#1E293B] text-slate-800 dark:text-white transition-colors duration-300">
        ...
        <p className="text-slate-500 dark:text-white/60 mb-4 max-w-md">
          {lessonTopic
            ? `There are no quiz questions seeded for the topic "${lessonTopic}" yet.`
            : "There are no quiz questions seeded for this lesson in the database yet."}
        </p>

        {hasSampleQuiz ? (
          <div className="mb-6 flex flex-col items-center gap-2">
            <p className="text-xs font-bold text-indigo-600 dark:text-indigo-400 uppercase tracking-widest mb-2">
              ✨ Quick Seeding Available
            </p>
            <Button
            ...
            <p className="text-[10px] text-slate-500 dark:text-white/40 italic">
              Click to populate this quiz with Grade 1 curriculum questions instantly
            </p>
          </div>
        ) : (
          <div className="mb-6 rounded-2xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 p-4 max-w-md text-left shadow-sm">
            <p className="text-xs font-bold text-yellow-600 dark:text-yellow-400 uppercase tracking-widest mb-1.5 flex items-center gap-1">
              💡 Developer / Student Hint
            </p>
            <p className="text-xs text-slate-600 dark:text-white/80 leading-relaxed font-semibold">
              The quizzes table is currently empty in your database. You can easily populate all
              Grade 1 quizzes by copying and running the{" "}
              <code className="bg-slate-100 dark:bg-white/15 px-1.5 py-0.5 rounded text-[11px] text-slate-800 dark:text-white">
                seed_quizzes_editor.sql
              </code>{" "}
              script (located in your workspace root folder) inside the **Supabase SQL Editor**
              dashboard.
            </p>
          </div>
        )}
        ...
        <Link to="/dashboard">
          <Button
            variant="outline"
            className="rounded-2xl font-black border-slate-300 dark:border-white/20 bg-slate-100 hover:bg-slate-200 dark:bg-white/5 dark:hover:bg-white/10 text-slate-800 dark:text-white px-6 cursor-pointer transition-all"
          >
            Back to Dashboard
          </Button>
        </Link>
    ...
    <div className="min-h-screen p-4 sm:p-6 lg:p-8 bg-gradient-to-tr from-slate-50 via-indigo-50/30 to-slate-100 dark:from-[#0F172A] dark:via-[#1E1B4B] dark:to-[#1E293B] text-slate-800 dark:text-white transition-colors duration-300 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-2xl">
        <Link
          to="/lesson/$lessonId"
          params={{ lessonId }}
          className="mb-4 inline-flex items-center gap-1 text-sm font-bold text-slate-500 hover:text-slate-800 dark:text-white/50 dark:hover:text-white transition-all"
        >
          <ArrowLeft className="h-4 w-4" /> Back to Lesson
        </Link>

        <div className="mb-6 flex items-center justify-between">
          <h1 className="font-heading text-2xl font-black text-slate-800 dark:text-white tracking-tight">
            Daily Quest Quiz
          </h1>
        ...
        <div className="mb-6 flex items-center gap-3">
          ...
          <span className="text-xs font-black text-slate-500 dark:text-white/60">
            {currentQ} / {total} Done
          </span>
        </div>
        ...
        {!submitted ? (
          ...
          >
            <div className="rounded-3xl border border-slate-200 dark:border-white/10 bg-white dark:bg-white/5 backdrop-blur-md p-6 shadow-md dark:shadow-2xl relative overflow-hidden">
              <p className="mb-1 text-xs font-bold text-indigo-600 dark:text-indigo-400 uppercase tracking-widest">
                Question {currentQ + 1} of {total}
              </p>
              <h2 className="mb-6 font-heading text-lg md:text-xl font-black text-slate-800 dark:text-white leading-relaxed">
                    ...
                    <div className="flex items-start gap-2.5">
                      ...
                      <div>
                        <h4 className="text-sm font-black uppercase tracking-wider">
                          {isCorrectFeedback ? "Excellent Job! 🎉" : "Not Quite! 💡"}
                        </h4>
                        <p className="text-xs text-slate-600 dark:text-white/70 font-semibold mt-1 leading-relaxed">
                          {isCorrectFeedback
                            ? "You nailed it!"
                            : `The correct option was ${currentQuiz.correct_answer}.`}{" "}
                          {getKidExplanation(currentQuiz)}
                        </p>
                      </div>
                    </div>
                  </motion.div>
            ...
            <div className="mt-6 flex justify-between">
              <Button
                ...
                onClick={() => {
                  const prev = quizzes[currentQ - 1];
                  setCurrentQ((q) => q - 1);
                  setSelected(prev ? answersRef.current[prev.id] || null : null);
                }}
          ...
          <AnimatePresence>
            {(() => {
              ...
              const tier =
                score >= 80
                  ? { label: "Outstanding! 🏆", color: "from-emerald-400 to-teal-500" }
                  : score >= 50
                    ? { label: "Good effort! 💪", color: "from-indigo-400 to-purple-500" }
              ...
              return (
                ...
                >
                  ...
                  <h2 className="font-heading text-3xl font-black text-slate-800 dark:text-white">
                    Quest Finished!
                  </h2>
                  <p className="mt-2 text-sm font-bold text-indigo-600 dark:text-indigo-300">
                    {tier.label}
                  </p>
                  <motion.p
                  ...
                  <div className="mt-6 grid grid-cols-3 gap-2 sm:gap-3 max-w-md mx-auto">
                    <div className="rounded-2xl bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/30 p-3">
                      <p className="font-heading text-2xl font-black text-emerald-600 dark:text-emerald-400">
                        {correctCount}
                      </p>
                      <p className="text-[10px] font-black uppercase tracking-wider text-emerald-700/80 dark:text-emerald-300/80 mt-0.5">
                        Correct
                      </p>
                    </div>
                    <div className="rounded-2xl bg-rose-50 dark:bg-rose-500/10 border border-rose-200 dark:border-rose-500/30 p-3">
                      <p className="font-heading text-2xl font-black text-rose-600 dark:text-rose-400">
                        {wrongCount}
                      </p>
                      <p className="text-[10px] font-black uppercase tracking-wider text-rose-700/80 dark:text-rose-300/80 mt-0.5">
                        Wrong
                      </p>
                    </div>
                    <div className="rounded-2xl bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 p-3">
                      <p className="font-heading text-2xl font-black text-slate-600 dark:text-white/70">
                        {skippedCount}
                      </p>
                      <p className="text-[10px] font-black uppercase tracking-wider text-slate-500 dark:text-white/50 mt-0.5">
                        Skipped
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:justify-center">
                    <Link to="/lesson/$lessonId" params={{ lessonId }} className="inline-flex">
                      <Button
                        variant="outline"
                        className="rounded-2xl font-black border-slate-300 dark:border-white/20 bg-slate-100 hover:bg-slate-200 dark:bg-white/5 dark:hover:bg-white/10 text-slate-800 dark:text-white px-6 cursor-pointer w-full"
                      >
                        Review Lesson
                      </Button>
                    </Link>
                    ...
                    <div className="mt-8 space-y-3 text-left border-t border-slate-200 dark:border-white/10 pt-6">
                      ...
                      {wrongResults.map((r, i) => {
                        ...
                        return (
                          ...
                          >
                            <p className="text-sm font-bold text-slate-800 dark:text-white/95 leading-relaxed mb-2.5">
                              {q?.question}
                            </p>
                            <div className="space-y-1.5 text-xs">
                              <div className="flex items-start gap-2">
                                ...
                                <p className="font-bold text-rose-700 dark:text-rose-300">
                                  ...
                                  <span className="font-black">
                                    {r.userAnswer
                                      ? `${r.userAnswer}. ${optionText(q, r.userAnswer)}`
                                      : "Not answered"}
                                  </span>
                                </p>
                              </div>
                              <div className="flex items-start gap-2">
                                ...
                                <p className="font-bold text-emerald-700 dark:text-emerald-300">
                                  Correct:{" "}
                                  <span className="font-black">
                                    {r.correctAnswer}. {optionText(q, r.correctAnswer)}
                                  </span>
                                </p>
                              </div>
                            </div>
