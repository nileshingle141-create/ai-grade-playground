...
| invalid lessonId → friendly fallback | `/lesson/00000000-0000-0000-0000-000000000000` | "Quest page was not found" | ❌ | expected text "Quest page was not found" not found. Body preview: AI Tutor Studio SUPER SCHOOL LEARNING PATH Dashboard Subjects Progress Log Out Learning Quest 🚀 Back to Quest Board min Quest Study Material 🤖 Have a doubt or need examples? Ask my AI Tutor chatb |
